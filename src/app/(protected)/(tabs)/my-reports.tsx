...
const ComplaintLink = ({ icon, title, description }) => (
  <TouchableOpacity className="flex-row items-center gap-4 bg-white p-5 rounded-xl transition-all duration-300 " style={localStyles.shadow}>
    {/* Icon on the left */}
    ...
    <View className="flex-1 flex-col justify-center">
      <Text className="text-gray-900 text-lg font-semibold" numberOfLines={1} ellipsizeMode="tail">{title}</Text>
      <Text className="text-gray-500 text-sm mt-1" numberOfLines={2} ellipsizeMode="tail">{description}</Text>
    </View>
